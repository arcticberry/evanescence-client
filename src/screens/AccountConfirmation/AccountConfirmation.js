...
const AccountConfirmation = () => {
	...
	const [doAccountConfirmation, accountConfirmationState] = useAccountConfirmationMutation();
	...
	React.useEffect(() => {
		...
		} else if (accountConfirmationState.isSuccess) {
			toast.error(accountConfirmationState.error.response.data.message);
		}
	}, [accountConfirmationState.isError, accountConfirmationState.isSuccess, accountConfirmationState.error]);
